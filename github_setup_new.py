#!/usr/bin/env python3
"""
GitHub Repository Setup Script (With New PAT)
...
def setup_git_and_push(username, repo_name):
    ...
    try:
        ...
        # Commit changes
        subprocess.run(['git', 'commit', '-m', 'Update: Telegram bot with Gemini integration'], check=True)
...
def create_readme():
    ...
    readme_content = """# Telegram Bot with Gemini Integration
